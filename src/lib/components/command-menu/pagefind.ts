...
export type PagefindIndexOptions = {
	 ...
	 *
	 * Only applies in multi-site setups, where one site should rank higher or lower than others.
	 */
	indexWeight?: number;
	/**
	 * Merge this filter object into all search queries in this index.
	 *
	 * Only applies in multi-site setups.
	 */
	mergeFilter?: Object;
	language?: string;
	/**
	 * Whether an instance of Pagefind is the primary index or not (for multi-site).
	 *
...
export type PagefindWordLocation = {
	 ...
	 *
	 * Splitting the content key by white-spacing and indexing by this number
